    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <form action="/tasks/update" method="post" id="form_tasks" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            ...
                            <div class="col-md-3" style="text-align: right;">
                                <button type="submit" class="btn green">{{ trans('tasks.buttons.update') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
